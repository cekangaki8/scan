...
import com.dpwn.smartscanus.deliverynetwork.interactor.DeliveryNetworkInteractor;
...
import com.dpwn.smartscanus.newopsapi.DeliveryNetworkProvider;
...
public class MainModules implements Module {
    ...
    public void configure(Binder binder) {
        ...
        //Delivery Network interface interaction
        binder.bind(IDeliveryNetworkScanningInputPort.class).to(DeliveryNetworkInteractor.class).asEagerSingleton();
