 ...
 */
public class SoritingServiceInteractor extends AbstractAsyncInteractor implements ISortingServiceInputPort {

    private static final String TAG = SoritingServiceInteractor.class.getSimpleName();
    ...
    public void processLinkSackScan(String barcode, String slot) {
        ...
        slot = StringUtils.remove(barcode, "\u001d");
