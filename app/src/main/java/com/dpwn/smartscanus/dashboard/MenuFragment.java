...
public class MenuFragment extends ScannerFragment {
    ...
    private static final String MENU_SCAN_SACK = "MENU_SCAN_SACK";
        ...
        gridView.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        } else if (MENU_SCAN_SACK.equalsIgnoreCase(strId)) {
                            fragmentContainer.setContentFragment(LinkSackFragment.class, true, null);
                        }
                    }
                }
        );
    ...
    private List<MenuElements> createMenuElements() {
       ...
       menuElementsList.add(new MenuElements(R.drawable.link_sack_icon, "Link Sack", "Link generic barcode " +
                "to slot. ", MENU_SCAN_SACK));
